...
public class DataGroup13 : DataGroup {
    ...
    public static let IDX_CARDINFO: UInt8 = 14
    public static let PREFIX_CARDINFO: [UInt8] = [48, 3, 2, 1, 14]
    ...
    override func parse(_ buf: [UInt8]) throws {
        ...
        for i in 0..<(separatorPositions.count - 1) {
            ...
            case DataGroup13.IDX_FAMILY:
                var seps: [Int] = []
                for j in (DataGroup13.PREFIX_FAMILY.count..<(subset.count - 2)) {
